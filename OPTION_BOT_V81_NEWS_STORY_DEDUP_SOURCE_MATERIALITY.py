...
def scan_top10(symbols=None, allow_watchlist_fallback=False):
    ...
    Strict candidates keep the original production gates:
      - stock direction aligned with contract side
    ...
    for symbol in target_symbols:
        try:
            ...
            # Direction remains a safety gate for "Best opportunities".
            ...
            # filters inside get_top_contracts (ask <= $5, volume >= 1000,
            ...
            decision = {
                ...
                "reason": (
                    ...
                    if is_manual_fallback
                    else "العقد متوافق مع اتجاه السهم الحالي"
                ),
                "rank": decision_rank,
            }
