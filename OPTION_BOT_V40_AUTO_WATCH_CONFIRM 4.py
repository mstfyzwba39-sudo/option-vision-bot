                ...
                if signature != LAST_AUTO_TOP_SIGNATURE:
                    ...
                    for user_id in ALLOWED_USERS:
                        try:
                            ...
                            # IMPORTANT: automatic opportunities must also be watched.
                            # A yellow/near opportunity is NOT an entry yet; it is added
                            # to the same 1H confirmation watcher used by manual scans.
