# OPTION_BOT V63 - resilient news providers and translation rate-limit protection
import os
import time
import math
import asyncio
...
def _select_diverse_macro_news(items, limit=5):
    ...
    items.sort(key=lambda x: (-x.get("importance",0), -x.get("timestamp",0), -_news_source_rank(x)))
