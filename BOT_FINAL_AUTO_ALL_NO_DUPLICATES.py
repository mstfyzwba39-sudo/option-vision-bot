...
# Persistent dedupe state survives app restarts/redeploys only within the same
# runtime filesystem. For Render this prevents ordinary process restarts from
# re-sending the same alerts during the deployment lifecycle.
...
def _load_auto_sent_state():
    try:
        ...
        return {
            "event_keys": set(data.get("event_keys") or []),
