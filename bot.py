...
SCAN_SYMBOLS = [
    ...
    "AI", "IONQ", "RGTI", "RKLB", "ASTS",
    "LUNR", "OKLO", "SMR", "QUBT", "QBTS",
    "AFRM", "UPST", "ROKU", "XYZ", "DDOG",
    "SNOW", "NOW", "PANW", "NET", "MDB",
    "U", "PATH", "ZM", "DOCU", "PINS",
    "DASH", "ABNB", "LYFT", "SBUX", "NKE",
    "TGT", "HD", "LOW", "MCD", "KO",
    "PEP", "DAL", "UAL", "AAL", "CCL",
    "RCL", "NCLH", "PFE", "LLY", "UNH",
    "MRK", "ABBV", "GILD", "WBD", "T",
]
    ...
    while True:
        ...
        for key, watch in list(
            ...
            try:
                ...
                option_now = await asyncio.to_thread(
...
async def buttons(
    ...
    if query.data == "top10":
        ...
        await query.message.reply_text(
            "🏆 جاري فحص 100 سهم...\n"
            "⏳ تقدرين تستخدمين البوت "
            "أثناء الفحص."
        )

        try:
            # أهم تعديل:
            # الفحص الثقيل يشتغل خارج event loop
