...
def add_pending_watch(
    ...
    # العقود المؤكدة أصلًا
    # لا تحتاج قائمة انتظار
    if (
        contract[
            "decision"
        ]["rank"]
