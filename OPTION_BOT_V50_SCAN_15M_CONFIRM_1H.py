...
async def monitor_auto_top_opportunities(application):
    ...
    The scan still runs hourly while the U.S. market is open, but a small score
    ...
    while True:
        try:
            ...
            qualified = [
                ...
                and str(item.get("decision", {}).get("state", "")).upper() in ("YELLOW", "GREEN")
            ]
            ...
            if triggered:
                ...
                msg = (
                    title
                    + "\n🟡 = انتظار تأكيد الساعة | 🟢 = الساعة أكدت الدخول\n\n"
