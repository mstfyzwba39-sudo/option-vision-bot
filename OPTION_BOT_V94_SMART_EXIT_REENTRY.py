# V94: SPX explicit mode=live + exact-quote diagnostics
                    ...
                    if market_open and now_ny.date() <= expiry_ny:
                        ...
                        if quote and float(quote.get("ask", 0) or 0) > 0:
                            ...
                            if entry > 0:
                                ...
                                if pnl_pct >= 50 and not item.get("profit_50_sent"):
                                    if early_exited:
                                        await _send_contract_alert(application, item,
                                            "📌 العقد بعد الخروج المبكر عاد وحقق +50٪ من سعر الدخول السابق\n\n"
                                            f"{line}\n💵 السعر الآن ${price:.2f}\n🎯 سعر الدخول السابق ${entry:.2f}\n"
                                            "ℹ️ للتقييم فقط — ليست الصفقة مفتوحة لدينا الآن.")
                                        hist["post_exit_profit_50"] = True
                                    else:
                                        await _send_contract_alert(application, item,
                                            "💰 ربح العقد وصل 50٪\n\n"
                                            f"{line}\n💵 السعر الآن ${price:.2f}\n🎯 سعر الدخول ${entry:.2f}")
                                ...
                                if pnl_pct >= 100 and not item.get("profit_100_sent"):
                                    if early_exited:
                                        await _send_contract_alert(application, item,
                                            "📌 العقد بعد الخروج المبكر عاد وحقق +100٪ من سعر الدخول السابق\n\n"
                                            f"{line}\n💵 السعر الآن ${price:.2f}\n🎯 سعر الدخول السابق ${entry:.2f}\n"
                                            "ℹ️ للتقييم فقط — ليست الصفقة مفتوحة لدينا الآن.")
                                        hist["post_exit_profit_100"] = True
                                    else:
                                        await _send_contract_alert(application, item,
                                            "💰 ربح العقد وصل 100٪\n\n"
                                            f"{line}\n💵 السعر الآن ${price:.2f}\n🎯 سعر الدخول ${entry:.2f}")
