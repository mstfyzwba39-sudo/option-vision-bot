...
def make_chart(symbol, resolution):
    ...
    if demand_zone:
        ...
        ax.text(
            ...
            color="#1F1F1F", fontsize=16.0, fontweight="bold", va="bottom", zorder=2,
        )
    ...
    if chart_targets:
        ...
        if len(points_y) >= 2:
            ...
            ax.plot(
                points_x, points_y, color=path_color, linewidth=3.0, alpha=0.96,
            ...
            ax.text(
                points_x[label_i] + 0.25, points_y[label_i] + atr_local * 0.30, label, color="#202020", fontsize=12.8,
