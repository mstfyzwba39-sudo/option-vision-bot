...
def make_chart(symbol, resolution):
    ...
    if zone_kind == "DEMAND":
        ...
        retest_text = (
            "السيناريو الأقرب: لا توجد حاليًا منطقة طلب/عرض موثوقة بما يكفي "
