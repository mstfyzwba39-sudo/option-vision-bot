...
def get_top_contracts(data, trend, soft_direction=False):
    ...
    for i in range(count):
        try:
            ...
            # نطاق الاستحقاق المعتمد لأفضل العقود/الفرص: من يوم واحد إلى 30 يومًا.
            if dte < 1 or dte > 30:
                continue
...
def scan_top10(symbols=None, allow_watchlist_fallback=False):
    ...
    for symbol in target_symbols:
        try:
            ...
            # OI >= 100, delta 0.20-0.80, spread <= 15%, DTE 1-30).
...
def format_exact_contract_evaluation(contract):
    ...
    if 7 <= dte <= 21:
        ...
        weaknesses.append("العقد أقل من يوم — خارج نطاق الفحص")
    elif dte > 30:
